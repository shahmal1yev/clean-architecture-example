...
/**
 * HTTP Adapter for Book Management
 * 
 * This adapter implements the Port interface and delegates
 * to Application Services. It handles input validation and
 * transformation between HTTP concerns and domain concepts.
 */
readonly class HttpBookManagementAdapter implements BookManagementPort
{
